      ...
      <div className="mx-auto max-w-7xl px-6 pt-14 text-center sm:pt-16 lg:px-8">
        ...
        <div className="relative mt-6 min-h-[15rem]">
          <p className="mx-auto max-w-2xl text-lg leading-8 text-white/60">
            Were 99% sure we have a plan tp match 100% of your needs
          </p>
          <svg
            viewBox="0 0 1208 1024"
            className="absolute -top-20 left-1/2 -z-10 h-[64rem] -translate-x-1/2 [mask-image:radial-gradient(closest-side,white,transparent)] sm:-top-24 md:-top-32 lg:-top-12 xl:top-0"
          >
            <ellipse
              cx={604}
              cy={512}
